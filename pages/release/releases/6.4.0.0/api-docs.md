...
<!-- API_VERSION_CHIP_END -->
      ...
      <div class="api-proof-list" role="list" aria-label="Platform highlights">
        ...
        <a class="api-fullspec-link" href="/specification/releases/6.4.0.0/finzly-connect-openapi" aria-label="View full OpenAPI spec">
  ...
  <div class="api-sections api-sections-narrow">
    <section class="api-section payment-domain" id="payment-api">
      ...
      <div class="subapi-grid">
        <a class="subapi-card" href="/specification/releases/6.4.0.0/payment-api/payments-openapi">
        ...
        <a class="subapi-card" href="/specification/releases/6.4.0.0/payment-api/bulk-payments-openapi">
        ...
        <a class="subapi-card" href="/specification/releases/6.4.0.0/payment-api/positive-pay-openapi">
        ...
        <a class="subapi-card" href="/specification/releases/6.4.0.0/finzly-connect-openapi/payments/createdebitpayment">
        ...
        <a class="subapi-card" href="/specification/releases/6.4.0.0/payment-api/transfer-openapi">
    ...
    <section class="api-section fx-domain" id="foreign-exchange-api">
      ...
      <div class="subapi-grid">
        <a class="subapi-card" href="/specification/releases/6.4.0.0/fx-api/fx-openapi">
    ...
    <section class="api-section customer-domain" id="customer-api">
      ...
      <div class="subapi-grid">
        <a class="subapi-card" href="/specification/releases/6.4.0.0/customer-api/customer-openapi">
        ...
        <a class="subapi-card" href="/specification/releases/6.4.0.0/customer-api/customer-account-openapi">
        ...
        <a class="subapi-card" href="/specification/releases/6.4.0.0/customer-api/customer-contact-openapi">
        ...
        <a class="subapi-card" href="/specification/releases/6.4.0.0/customer-api/customer-user-openapi">
        ...
        <a class="subapi-card" href="/specification/releases/6.4.0.0/customer-api/customer-role-openapi">
    ...
    <section class="api-section webhook-domain" id="webhook-api">
      ...
      <div class="subapi-grid">
        <a class="subapi-card" href="/specification/releases/6.4.0.0/webhook-api/payments-webhook-openapi/payment-webhook-notifications./notifypaymentstatus">
        ...
        <a class="subapi-card" href="/specification/releases/6.4.0.0/webhook-api/payments-webhook-openapi/ledger-transaction-webhook/handletransactionupdate">
    ...
    <section class="api-section bank-domain" id="bank-api">
      ...
      <div class="subapi-grid">
        <a class="subapi-card" href="/specification/releases/6.4.0.0/payment-api/banks-openapi">
    ...
    <section class="api-section finzlycore-domain" id="finzlycore-api">
      ...
      <div class="subapi-grid">
        <a class="subapi-card" href="/specification/releases/6.4.0.0/finzlycore-api/deposit-accounts-openapi">
